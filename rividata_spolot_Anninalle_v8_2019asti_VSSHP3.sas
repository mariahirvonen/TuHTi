...
*/
libname S2_5_in 'P:\Projektit\Tyoajat\Suojatut\Titania_saadut\work_data_lapa2019\vsshp'  access=readonly;

libname S2_6_in 'P:\Projektit\Tyoajat\Suojatut\Titania_saadut\work_data_upto2020\vsshp'  access=readonly;
...
*	JAKSO3=200401;
	do i=1 to 5000;
		...
		if AHETKI_PVM=mdy(12,18,2017) then JAKSO3=201801;
...
%macro_sisaan(S2_1_in, VSSHP_upto2014end_t002_clean, 2, VSSHP1);
%macro_sisaan(S2_2_in, VSSHP_t002_clean, 2, VSSHP2);
%macro_sisaan(S2_3_in, VSSHP_t002_clean, 2, VSSHP3);
%macro_sisaan(S2_5_in, VSSHP_t002_clean, 2, VSSHP4);
%macro_sisaan(S2_6_in, VSSHP_t002_clean, 2, VSSHP5);

title1'1';
proc freq data=VSSHP1;
	tables svuosi;
run;
title1'2';
proc freq data=VSSHP2;
	tables svuosi;
run;
title1'3';
proc freq data=VSSHP3;
	tables svuosi;
run;
title1'4';
proc freq data=VSSHP4;
	tables svuosi;
run;
title1'5';
proc freq data=VSSHP5;
	tables svuosi;
run;
...
%macro_process_rdata (Pirkanmaa1, Pirkanmaa1_2, '1', '1', '2006', '12', '31', '2015');
%macro_process_rdata (Pirkanmaa3, Pirkanmaa3_2, '1', '1', '2016', '12', '31', '2017');
...
*/
proc contents data=VSSHP1_2 position; run;

data slayht1;
	set
		VSSHP1_2 VSSHP2_2 VSSHP3_2 VSSHP4_2 VSSHP5_2;
*		Kantahame1_2 Kantahame3_2
		Vaasa1_2 Vaasa3_2
		Pirkanmaa1_2 Pirkanmaa3_2
		Pietarsaari1_2 Pietarsaari3_2
		Forssa1_2 Forssa2_2 Forssa3_2	
	;
run;
/*	
data K10yht1;
